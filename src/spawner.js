...
const spawnBuilder = () => {
    Game.spawns['spawn'].spawnCreep([WORK, WORK, CARRY, MOVE], `builder-${Game.time}`, {memory: {role: 'builder'}});
}
const spawnUpgrader = () => {
    Game.spawns['spawn'].spawnCreep([WORK, WORK, CARRY, MOVE], `upgrader-${Game.time}`, {memory: {role: 'upgrader'}});
}
